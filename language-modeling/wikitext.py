...
_DATA_URL = ".\\datas\\wikitext-2-raw-v1\\wikitext-2-raw\\"
            ...
            if self.config.name == "wikitext-103-raw-v1":
                ...
                if self.config.name == "wikitext-2-raw-v1":
                    ...
                    return [
                        datasets.SplitGenerator(
                            name=datasets.Split.TEST,
                            gen_kwargs={"data_file": _DATA_URL+"wiki.test.raw", "split": "test"},
                        ),
                        datasets.SplitGenerator(
                            name=datasets.Split.TRAIN,
                            gen_kwargs={"data_file": _DATA_URL+'wiki.train.raw', "split": "train"},
                        ),
                        datasets.SplitGenerator(
                            name=datasets.Split.VALIDATION,
                            gen_kwargs={"data_file": _DATA_URL+"wiki.valid.raw", "split": "valid"},
                        ),
                    ]
                else:
